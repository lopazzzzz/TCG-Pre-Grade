...
export const translations = {
  th: {
    ...
    analyze_all_btn: (n) => (n > 1 ? `วิเคราะห์ทั้งหมด (${n})` : 'ส่งข้อมูล'),
    ...
    grade_new_card_btn: '➕ เกรดการ์ดใหม่',
    ...
    card_tab_label: (n) => `การ์ด ${n}`,
    add_card_tooltip: 'เพิ่มการ์ด',
    max_cards_reached: 'สูงสุด 10 ใบต่อรอบ',
    remove_card_confirm: 'ลบการ์ดใบนี้ออกจากชุดนี้?',
    analyze_all_error: 'กรุณาอัปโหลดรูป จัดตำแหน่ง และวัด Centering ให้ครบทุกใบก่อนวิเคราะห์',
  ...
  en: {
    ...
    analyze_btn: 'Submit',
    analyze_all_btn: (n) => (n > 1 ? `Analyze All (${n})` : 'Submit'),
    ...
    grade_new_card_btn: '➕ Grade New Card',
    ...
    card_tab_label: (n) => `Card ${n}`,
    add_card_tooltip: 'Add card',
    max_cards_reached: 'Maximum 10 cards per batch',
    remove_card_confirm: 'Remove this card from the batch?',
    analyze_all_error: 'Please upload, align, and confirm centering for every card before analyzing',
